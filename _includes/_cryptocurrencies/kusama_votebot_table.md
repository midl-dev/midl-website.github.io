        ...
        <div class="card btn-no-waves">
            <div class="card-body" style="text-align: center;">
                ...
                <table class="table table-borderless" style="padding:0px;">
                    <thead>
                    <tr>
                        <th style="border-top:none; border-bottom:none;" colspan="1" scope="col" class="midl-table-title">Automated Kusama Vote Bot Subscription</th>
                    </tr>
                    </thead>
                    <tbody>
                    <tr>
                        <td>Recurring monthly price: US$14.99</td>
                    </tr>
                    <tr>
